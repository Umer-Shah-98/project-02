                  ...
                  {expenses.map((expense)=>{
                    ...
                    return(
                      ...
                      <div  className="flex justify-between my-2">
                        <div className="text-lg ml-1">{expense.description}</div>
                        <div className="flex items-center">
                        <div className="mx-8 text-lg font-bold">{currencyFormatter.format(expense.amount)}
                        </div>
                        <div>
                          <button onClick={()=>deleteExpense(expense)} className="hover:bg-red-600 rounded-md w-8 text-lg font-bold">&times;</button>
                        </div>
                        </div>
                      </div>
